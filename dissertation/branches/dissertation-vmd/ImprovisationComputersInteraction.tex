...
%% Interaction
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% \input{include/ImpComInt-title.tex}
% \cleardoublepage
...
\input{include/ImpComInt-abstract.tex}
...
\input{include/ImpComInt-introduction.tex}
...
\input{include/ImpComInt-ethsnd.refl.tex}
\input{include/ImpComInt-ethsnd.descr.tex}
\input{include/ImpComInt-ethsnd.concl.tex}

\chapter[Repetition]{Repetition Repeats all other Repetitions}
\label{cha:repe-main}
\input{include/ImpComInt-negotiate.tex}

\chapter[Interaction]{Interaction and the Self}
\label{sec:interraction-self}
\input{include/ImpComInt-interaction-1.tex}
\input{include/ImpComInt-interaction-2.tex}
%\input{include/ImpComInt-self.tex}
...
\input{include/ImpComInt-ending.tex}
