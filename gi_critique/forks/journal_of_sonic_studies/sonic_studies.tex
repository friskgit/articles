...
\begin{quote}
if artistic research is supposed to be different from all other kinds of research, it is natural to focus on the artist as the researcher, and what is specific for the artist is her or his privileged access to her or his own creative process. (\cslcitation{23}{Kjørup, 2010} , p. 25)
\end{quote}
...
These questions are still of relevance in artistic research and the point on which this discipline is most often criticized.\footnote{For a broader discussion on this topic, see Frisk \& Östersjö (\cslcitation{16}{2013}).}
...
\label{sec:org044397a}
\begin{cslbibliography}{1}{0}
\cslbibitem{1}{Aron, L. (2023). \textit{Phainesthai: Discovering auditory processes as a tool for musical composition}. Royal College of Music, Stockholm.}

\cslbibitem{2}{Bergson, H. (1912). \textit{An introduction to metaphysics}. G. P. Putnam’s Son: New York.}

\cslbibitem{3}{Bergson, H. (1991). \textit{Matter and memory}. Zone Books, NY.}

\cslbibitem{4}{Borgdorff, H. (2007). The debate on research in the arts. \textit{Dutch Journal of Music Theory}, \textit{12}(1), 1–17.}

\cslbibitem{5}{Borgdorff, H. (2010). The production of knowledge in artistic research. In M. Biggs \& H. Karlsson (Eds.), \textit{The routledge companion to research in the arts} (pp. 44–63). Routledge.}

\cslbibitem{6}{Catena, S. (2021). Real-time algorithmic timbral spatialisation: Compositional approaches and techniques. \textit{Proceedings of the 18th Sound and Music Computing (Smc) Conference, Torino, 2021}, 338–344.}

\cslbibitem{7}{Catena, S. (2022). Concepts and approaches in analysing spatial gestures: a link between mozart and acousmatic music. \textit{2022 Xxiii Colloqui D’informatica Musicale, Ancona}.}

\cslbibitem{8}{Clair, A. (1996). Merleau-ponty lecteur et critique de bergson. le statut bergsonien de l’intuition. \textit{Archives de Philosophie}, 203–218.}

\cslbibitem{9}{Clarke, E. F. (2005). \textit{Ways of Listening: An Ecological Approach to the Perception of Musical Meaning}. Oxford University Press, USA.}

\cslbibitem{10}{Deleuze, G. (1988). \textit{Bergsonism} (H. Tomlinson \& B. Habberjam, Trans.). Zone Books, Urzone Inc, New York.}

\cslbibitem{11}{Diagne, S. B. (2008). Bergson in the colony: Intuition and duration in the thought of senghor and iqbal. \textit{Qui Parle}, \textit{17}(1), 125–145.}

\cslbibitem{12}{Dokic, J. (2007). Two ontologies of sound. \textit{The Monist}, \textit{90}(3), 391–402.}

\cslbibitem{13}{Frayling, C. (1993). Research in art and design. \textit{Royal College of Art Research Papers Series.}, \textit{1}(1).}

\cslbibitem{14}{Frisk, H. (2014). Improvisation and the self: to listen to the other. In F. Schroeder \& M. Ó hAodha (Eds.), \textit{Soundweaving: Writings on improvisation}. Cambridge Scholars Publishing.}

\cslbibitem{15}{Frisk, H. (2020). Aesthetics, interaction and machine improvisation. \textit{Organised Sound}, \textit{25}(1), 33–40. \url{https://doi.org/10.1017/S135577181900044X}}

\cslbibitem{16}{Frisk, H., \& Östersjö, S. (2013). Beyond validity: claiming the legacy of the artist-researcher. \textit{Swedish Journal of Music Research}, \textit{2013}, 41–63.}

\cslbibitem{17}{Galdon, F., \& Hall, A. (2022). (un)frayling design research in design education for the 21cth. \textit{The Design Journal}, \textit{25}(6), 915–933. \url{https://doi.org/10.1080/14606925.2022.2112861}}

\cslbibitem{18}{Gaver, W. W. (1993). \textit{What in the world do we hear? An ecological approach to auditory event perception} (pp. 1–29). Ecological Psychology.}

\cslbibitem{19}{Helmholtz, H. (1954). \textit{On the sensations of tone}. Dover Publications, Incorporated.}

\cslbibitem{20}{Hirai, Y. (2023). \textit{Bergson’s scientific metaphysics : matter and memory today.} Bloomsbury Academic.}

\cslbibitem{21}{Ingman, B. C. (2022). Artistic sensibility is inherent to research. \textit{International Journal of Qualitative Methods}, \textit{21}, 160940692110692. \url{https://doi.org/10.1177/16094069211069267}}

\cslbibitem{22}{Kelly, M. R. (2010). \textit{Bergson and phenomenology}. Palgrave Macmillan.}

\cslbibitem{23}{Kjørup, S. (2010). Pleading for plurality: artistic and other kinds of research. In M. Biggs \& H. Karlsson (Eds.), \textit{The routledge companion to research in the arts} (pp. 24–43). Routledge.}

\cslbibitem{24}{Lawlor, L. (2003). \textit{The Challenge of Bergsonism}. Continuum.}
...
\cslbibitem{27}{Patton, M. (2002). \textit{Qualitative research \& evaluation methods}. SAGE Publications.}

\cslbibitem{28}{Russell, B. (1981). \textit{Mysticism and logic, and other essays}. Barnes \& Noble Books.}

\cslbibitem{29}{Schaeffer, P. (1977). \textit{Traité des objets musicaux:essai interdisciplines}. Éditions du Seuil.}

\cslbibitem{30}{Shklar, J. (1958). Bergson and the politics of intuition. \textit{The Review of Politics}, \textit{20}(4), 634–656. \url{https://doi.org/10.1017/s0034670500034264}}

\cslbibitem{31}{Smalley, D. (1986). \textit{Spectromorphotogy and structuring processes} (pp. 61–93). Basingstoke, Macmillan Press.}

\cslbibitem{32}{Tenney, J. (2008). On ’crystal growth’ in harmonic space (1993 - 1998). \textit{Contemporary Music Review}, \textit{27}(1), 47–56.}

\cslbibitem{33}{Thompson, G. (2009). Artistic sensibility in the studio and gallery model: Revisiting process and product. \textit{Art Therapy}, \textit{26}(4), 159–166.}

\cslbibitem{34}{Tresch, J., \& Dolan, E. I. (2013). Toward a new organology: Instruments of music and science. \textit{Osiris}, \textit{28}(1), 278–298. \url{https://doi.org/10.1086/671381}}

\cslbibitem{35}{Tuin, I. V. D. (2011). “a different starting point, a different metaphysics”: Reading bergson and barad diffractively. \textit{Hypatia}, \textit{26}(1), 22–42. \url{https://doi.org/10.1111/j.1527-2001.2010.01114.x}}

\cslbibitem{36}{Valle, A. (2018). Sampcomp: sample-based techniques for algorithmic composition. \textit{Proceedings of the 22nd Cim}, 128–135.}
