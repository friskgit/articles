...
\hypersetup{pdfauthor={Henrik Frisk and Stefan Östersjö}}
...
\title{\begin{minipage}[t]{0.98\textwidth}\begin{center}
      {\mdseries Negotiating the musical work II. \\Computer-Performer interaction in relation to Composer-Performer
interaction.\\}
\vspace{1cm}
     {\mdseries DTPA 2006}
